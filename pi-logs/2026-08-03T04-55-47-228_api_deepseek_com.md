...
- **timestamp**: 2026-08-03T04:55:47.228Z
...
- **tools**: 13 definitions, 18,620 bytes (~4,655 tokens)
- **system prompt**: 8,237 bytes (~2,059 tokens)
- **total request**: 27,227 bytes

**Tools, ranked by size:**

| tool | bytes | ~tokens | % of request |
| --- | --: | --: | --: |
| Agent | 7,807 | ~1,952 | 28.7% |
| mcp | 2,550 | ~638 | 9.4% |
| web_fetch | 1,215 | ~304 | 4.5% |
| edit | 1,194 | ~299 | 4.4% |
| grep | 1,054 | ~264 | 3.9% |
| web_search | 757 | ~189 | 2.8% |
| read | 699 | ~175 | 2.6% |
| find | 631 | ~158 | 2.3% |
| steer_subagent | 627 | ~157 | 2.3% |
| get_subagent_result | 597 | ~149 | 2.2% |
| bash | 557 | ~139 | 2.0% |
| ls | 487 | ~122 | 1.8% |
| write | 445 | ~111 | 1.6% |
