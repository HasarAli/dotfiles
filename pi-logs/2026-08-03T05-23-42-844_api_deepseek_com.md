...
- **timestamp**: 2026-08-03T05:23:42.844Z
...
- **tools**: 13 definitions, 14,040 bytes (~3,510 tokens)
- **system prompt**: 0 bytes (~0 tokens)
- **total request**: 22,650 bytes

**Tools, ranked by size:**

| tool | bytes | ~tokens | % of request |
| --- | --: | --: | --: |
| Agent | 3,227 | ~807 | 14.2% |
| mcp | 2,550 | ~638 | 11.3% |
| web_fetch | 1,215 | ~304 | 5.4% |
| edit | 1,194 | ~299 | 5.3% |
| grep | 1,054 | ~264 | 4.7% |
| web_search | 757 | ~189 | 3.3% |
| read | 699 | ~175 | 3.1% |
| find | 631 | ~158 | 2.8% |
| steer_subagent | 627 | ~157 | 2.8% |
| get_subagent_result | 597 | ~149 | 2.6% |
| bash | 557 | ~139 | 2.5% |
| ls | 487 | ~122 | 2.2% |
| write | 445 | ~111 | 2.0% |
...
- Explore: Fast read-only search agent for locating code. (Tools: read, bash, grep, find, ls)
- Plan: Software architect agent for designing implementation plans. (Tools: read, bash, grep, find, ls)

Custom agents: .pi/agents/<name>.md (project) or /home/hasar/.pi/agent/agents/<name>.md (global).
