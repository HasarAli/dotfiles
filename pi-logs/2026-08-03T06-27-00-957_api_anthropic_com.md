...
- **timestamp**: 2026-08-03T06:27:00.957Z
...
- **tools**: 13 definitions, 13,849 bytes (~3,462 tokens)
- **system prompt**: 8,282 bytes (~2,071 tokens)
- **total request**: 22,420 bytes

**Tools, ranked by size:**

| tool | bytes | ~tokens | % of request |
| --- | --: | --: | --: |
| Agent | 3,140 | ~785 | 14.0% |
| mcp | 2,549 | ~637 | 11.4% |
| web_fetch | 1,200 | ~300 | 5.4% |
| edit | 1,179 | ~295 | 5.3% |
| grep | 1,039 | ~260 | 4.6% |
| web_search | 790 | ~198 | 3.5% |
| read | 684 | ~171 | 3.1% |
| find | 616 | ~154 | 2.7% |
| steer_subagent | 612 | ~153 | 2.7% |
| get_subagent_result | 582 | ~146 | 2.6% |
| bash | 542 | ~136 | 2.4% |
| ls | 486 | ~122 | 2.2% |
| write | 430 | ~108 | 1.9% |
...
```json
{
  ...
  "properties": {
    ...
    "subagent_type": {
      "type": "string",
      "description": "The type of specialized agent to use. Available types: general-purpose. Custom agents from .pi/agents/*.md (project) or /home/hasar/.pi/agent/agents/*.md (global) are also available."
    },
    "model": {
      "type": "string",
